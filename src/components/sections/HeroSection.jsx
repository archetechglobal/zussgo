...
export default function HeroSection() {
  const activeMatch = useCyclicIndex(
    LIVE_MATCHES.length,
    MATCH_TICKER_INTERVAL_MS,
  );
  ...
  return (
    ...
    >
      <div style={{ animation: "slideUp 1s ease forwards", maxWidth: "800px" }}>
        ...
        >
          Find real travelers heading to your destination, on your dates. Match.
          Chat. Go together.
        </p>
        ...
        >
          <ButtonPrimary onClick={() => scrollToSection("quiz")}>
            Find Your Travel Match →
          </ButtonPrimary>
          <ButtonSecondary onClick={() => scrollToSection("how-it-works")}>
            How It Works
          </ButtonSecondary>
        </div>
        ...
        >
          🔥 {WAITLIST_COUNT.toLocaleString()}+ travelers already on the
          waitlist
        </p>
      </div>
